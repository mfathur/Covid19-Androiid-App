...
class CountryListAdapter :ListAdapter<Country,CountryListAdapter.CountryViewHolder>(CountryCallBack()){
...
private class CountryCallBack:DiffUtil.ItemCallback<Country>(){
