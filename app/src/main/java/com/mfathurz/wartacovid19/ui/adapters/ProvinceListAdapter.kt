...
class ProvinceListAdapter : ListAdapter<ProvinceData, ProvinceListAdapter.ProvinceViewHolder>(
    PROVINCE_COMPARATOR
) {
    ...
    companion object {
        private val PROVINCE_COMPARATOR = object : DiffUtil.ItemCallback<ProvinceData>() {
